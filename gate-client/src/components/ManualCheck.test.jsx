...
describe('ManualCheck', () => {
  ...
  it('renders ID type select and number input', () => {
    render(<ManualCheck onBack={vi.fn()} onSwitch={vi.fn()} />);
  ...
  it('calls onSwitch when switch button clicked', () => {
    ...
    render(<ManualCheck onBack={vi.fn()} onSwitch={onSwitch} />);
    fireEvent.click(screen.getByText('📷 Switch to Scan ID Card'));
